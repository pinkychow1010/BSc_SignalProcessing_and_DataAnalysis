...
Also, Mass change in part of the ocean is not important for the analysis \
...
print("Land: Land is moderately regularized since noise is obvious in the unregularized solution. \
